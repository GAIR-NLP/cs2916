...
from src.trainer.ray.utils import ray_noset_visible_devices
...
class LLMRayActor:
    def __init__(self, *args, **kwargs):
        ...
        assert self.__version__ >= "0.4.2", "src only supports vLLM >= 0.4.2"
        ...
        if self.use_gpu_executor:
            ...
            if vllm.__version__ > "0.6.4.post1":
                ...
                kwargs["worker_cls"] = "src.trainer.ray.vllm_worker_wrap.WorkerWrap"
            else:
                RayWorkerWrapperPath = vllm.executor.ray_utils

                class RayWorkerWrapper(RayWorkerWrapperPath.RayWorkerWrapper):
                    def __init__(self, *args, **kwargs) -> None:
                        kwargs["worker_module_name"] = "src.trainer.ray.vllm_worker_wrap"
